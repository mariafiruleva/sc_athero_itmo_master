...
kallisto bus -i /home/Mus_musculus.GRCm38.cdna.all.idx -x 10xv3 -t 4 -o bus_out/ R1.gz R2.gz 
mkdir bus_out/tmp
bustools correct -w /files/10xv3_whitelist.txt -o bus_out/correct_output.bus bus_out/output.bus
