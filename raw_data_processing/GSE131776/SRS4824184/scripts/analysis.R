...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824184")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824184/counts.RData"))
...
save('whole', file = "SRS4824184.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS4824184.h5ad",
