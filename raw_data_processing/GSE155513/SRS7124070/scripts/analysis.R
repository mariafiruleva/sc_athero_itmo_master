...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124070")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124070/counts.RData"))
...
save('whole', file = "SRS7124070.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124070.h5ad",
