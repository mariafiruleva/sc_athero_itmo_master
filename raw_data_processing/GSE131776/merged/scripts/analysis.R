...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/merged")
set.seed(1)
...
save(list = c('whole.integrated', 'whole.features', 'whole.anchors'), file = "GSE131776.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole.integrated, outFile="GSE131776.h5ad",
