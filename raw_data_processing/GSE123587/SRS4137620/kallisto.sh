mkfifo R1.gz R2.gz
curl -Ls ftp://{ftp.sra.ebi.ac.uk/vol1/fastq/SRR831/004/SRR8310804/SRR8310804_1.fastq.gz} > R1.gz &
curl -Ls ftp://{ftp.sra.ebi.ac.uk/vol1/fastq/SRR831/004/SRR8310804/SRR8310804_2.fastq.gz} > R2.gz &
