...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514323")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514323/counts.RData"))
...
whole <- FindClusters(object = whole, resolution = c(0.2, 0.4, 0.6))
...
library(reticulate)
target_path <- gsub('counts.RData', '', "/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514323/counts.RData")
