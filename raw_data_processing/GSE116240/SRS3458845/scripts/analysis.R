...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE116240/SRS3458845")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE116240/SRS3458845/counts.RData"))
...
save('whole', file = "SRS3458845.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS3458845.h5ad",
