...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE116240/SRS3458842")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE116240/SRS3458842/counts.RData"))
...
save('whole', file = "SRS3458842.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS3458842.h5ad",
