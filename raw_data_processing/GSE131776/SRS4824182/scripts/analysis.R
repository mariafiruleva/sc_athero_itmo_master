...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824182")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824182/counts.RData"))
...
save('whole', file = "SRS4824182.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS4824182.h5ad",
