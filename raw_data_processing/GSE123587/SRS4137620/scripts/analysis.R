...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE123587/SRS4137620")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE123587/SRS4137620/counts.RData"))
...
save('whole', file = "SRS4137620.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS4137620.h5ad",
