...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE154817/SRS7052767")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE154817/SRS7052767/counts.RData"))
...
save('whole', file = "SRS7052767.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7052767.h5ad",
