...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041375")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041375/counts.RData"))
...
save('whole', file = "SRS7041375.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7041375.h5ad",
