...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124065")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124065/counts.RData"))
...
save('whole', file = "SRS7124065.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124065.h5ad",
