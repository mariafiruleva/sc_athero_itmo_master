...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124069")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124069/counts.RData"))
...
save('whole', file = "SRS7124069.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124069.h5ad",
