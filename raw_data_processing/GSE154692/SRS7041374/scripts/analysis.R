...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041374")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041374/counts.RData"))
...
save('whole', file = "SRS7041374.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7041374.h5ad",
