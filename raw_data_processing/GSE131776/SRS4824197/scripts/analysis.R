...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824197")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824197/counts.RData"))
...
save('whole', file = "SRS4824197.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS4824197.h5ad",
