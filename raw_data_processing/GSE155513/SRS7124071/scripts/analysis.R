...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124071")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124071/counts.RData"))
...
save('whole', file = "SRS7124071.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124071.h5ad",
