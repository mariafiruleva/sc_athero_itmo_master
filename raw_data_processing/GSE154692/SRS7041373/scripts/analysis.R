...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041373")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041373/counts.RData"))
...
save('whole', file = "SRS7041373.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7041373.h5ad",
