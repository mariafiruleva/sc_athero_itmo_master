...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE123587/merged")
set.seed(1)
...
whole <- get_whole_obj(c("/mnt/tank/scratch/mfiruleva/scn/data/GSE123587/SRS4137616/counts.RData", "/mnt/tank/scratch/mfiruleva/scn/data/GSE123587/SRS4137620/counts.RData"))

## CREATE DIRECTORY FOR PLOTS
path <- "plots_GSE123587/"
dir.create(path)
...
save(list = c('whole.integrated', 'whole.features', 'whole.anchors'), file = "GSE123587.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole.integrated, outFile="GSE123587.h5ad",
