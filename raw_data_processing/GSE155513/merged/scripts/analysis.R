...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/merged")
set.seed(1)
...
save(list = c('whole.integrated', 'whole.features', 'whole.anchors'), file = "GSE155513.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole.integrated, outFile="GSE155513.h5ad",
