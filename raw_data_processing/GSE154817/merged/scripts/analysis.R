...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE154817/merged")
set.seed(1)
...
whole <- get_whole_obj(c("/mnt/tank/scratch/mfiruleva/scn/data/GSE154817/SRS7052767/counts.RData", "/mnt/tank/scratch/mfiruleva/scn/data/GSE154817/SRS7052768/counts.RData"))

## CREATE DIRECTORY FOR PLOTS
path <- "plots_GSE154817/"
dir.create(path)
...
save(list = c('whole.integrated', 'whole.features', 'whole.anchors'), file = "GSE154817.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole.integrated, outFile="GSE154817.h5ad",
