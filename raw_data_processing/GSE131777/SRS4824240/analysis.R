...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/SRS4824240/counts.RData"))
...
# file_out <- paste0(gsub('/SRR.*', '', stringr::str_extract("/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/SRS4824240/counts.RData", 'SRS.*')), '.RData')
...
target_path <- gsub('counts.RData', '', "/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/SRS4824240/counts.RData")
