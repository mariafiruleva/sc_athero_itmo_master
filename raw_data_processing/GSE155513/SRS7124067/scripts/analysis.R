...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124067")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124067/counts.RData"))
...
save('whole', file = "SRS7124067.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124067.h5ad",
