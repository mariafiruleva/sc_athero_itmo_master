...
setwd("/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/merged")
set.seed(1)
...
whole <- get_whole_obj(c("/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/SRS4824239/counts.RData", "/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/SRS4824240/counts.RData", "/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/SRS4824241/counts.RData", "/mnt/tank/scratch/mfiruleva/scn/10_fq/GSE131777/SRS4824242/counts.RData"))

## CREATE DIRECTORY FOR PLOTS
path <- "plots_GSE131777/"
dir.create(path)
...
save(list = c('whole.integrated', 'whole.features', 'whole.anchors'), file = "GSE131777.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole.integrated, outFile="GSE131777.h5ad",
