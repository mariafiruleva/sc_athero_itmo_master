...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124068")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124068/counts.RData"))
...
save('whole', file = "SRS7124068.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124068.h5ad",
