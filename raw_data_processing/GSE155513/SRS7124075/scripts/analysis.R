...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124075")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124075/counts.RData"))
...
save('whole', file = "SRS7124075.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124075.h5ad",
