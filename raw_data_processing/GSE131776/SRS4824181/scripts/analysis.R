...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824181")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE131776/SRS4824181/counts.RData"))
...
save('whole', file = "SRS4824181.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS4824181.h5ad",
