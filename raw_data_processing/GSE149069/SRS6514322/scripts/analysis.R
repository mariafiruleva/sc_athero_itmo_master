...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514322")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514322/counts.RData"))
...
library(reticulate)
target_path <- gsub('counts.RData', '', "/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514322/counts.RData")
