...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/merged")
set.seed(1)
...
whole <- get_whole_obj(c("/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514323/counts.RData", "/mnt/tank/scratch/mfiruleva/scn/data/GSE149069/SRS6514322/counts.RData"))

## CREATE DIRECTORY FOR PLOTS
path <- "plots_GSE149069/"
dir.create(path)
...
save(list = c('whole.integrated', 'whole.features', 'whole.anchors'), file = "GSE149069.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole.integrated, outFile="GSE149069.h5ad",
