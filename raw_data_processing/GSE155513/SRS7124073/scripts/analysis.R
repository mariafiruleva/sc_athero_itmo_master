...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124073")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124073/counts.RData"))
...
save('whole', file = "SRS7124073.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124073.h5ad",
