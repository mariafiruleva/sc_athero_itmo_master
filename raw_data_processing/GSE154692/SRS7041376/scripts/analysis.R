...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041376")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE154692/SRS7041376/counts.RData"))
...
save('whole', file = "SRS7041376.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7041376.h5ad",
