...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124066")
set.seed(1)
...
whole <- get(load("/mnt/tank/scratch/mfiruleva/scn/data/GSE155513/SRS7124066/counts.RData"))
...
save('whole', file = "SRS7124066.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole, outFile="SRS7124066.h5ad",
