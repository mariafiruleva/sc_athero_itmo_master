...
setwd("/mnt/tank/scratch/mfiruleva/scn/data/GSE116240/merged")
set.seed(1)
...
whole <- get_whole_obj(c("/mnt/tank/scratch/mfiruleva/scn/data/GSE116240/SRS3458842/counts.RData", "/mnt/tank/scratch/mfiruleva/scn/data/GSE116240/SRS3458845/counts.RData"))

## CREATE DIRECTORY FOR PLOTS
path <- "plots_GSE116240/"
dir.create(path)
...
save(list = c('whole.integrated', 'whole.features', 'whole.anchors'), file = "GSE116240.RData")
  

library(reticulate)

sceasy:::seurat2anndata(whole.integrated, outFile="GSE116240.h5ad",
